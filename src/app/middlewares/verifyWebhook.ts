...
export const verifyCinetPayWebhook = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (!secret) {
    return res.status(500).json({ message: 'Server misconfiguration: missing webhook secret' });
  }
